      ...
      <section className="mx-auto w-full max-w-7xl px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-6 text-center">
          ...
          <p className="text-base text-muted-foreground max-w-2xl mx-auto">
            An autonomous robot combining detection technology, precise localization, and in-situ repair capabilities.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-5xl space-y-12">
          <div className="text-center">
            <h2 className="text-3xl font-semibold mb-3">Crack Detection Technology</h2>
          </div>
              ...
              <Card className="border">
                ...
                <CardContent className="pt-0">
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    ...
                    to detect cracks using <strong className="text-foreground">S0 guided waves</strong> that propagate along the pipe wall.
                  </p>
              ...
              <Card className="border">
                ...
                <CardContent className="pt-0">
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    envelopes. Statistical thresholding based on <strong className="text-foreground">POD/PFA</strong> metrics 
